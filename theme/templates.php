...
<head>
<meta charset="utf-8">
<title>PESO Job Hunt App / <?php echo $title;?></title>
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
<meta name="description" content="" />
<meta name="author" content="http://webthemez.com" />
<link rel="shortcut icon" href="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" type="image/x-icon">
<!-- css -->
  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
                <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>+035 226-3530</p>
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php"><img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" height="32" width="32"alt="logo"/> Job Hunt App</a>
                </div>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          <address>
          <strong>Dumaguete City PESO Office</strong><br>
          Dumaguete City Hall, Dumaguete City<br>
          Negros Oriental, 6201.</address>
          <p>
            <i class="icon-phone"></i> (035) 226-3530 <br>
            <i class="icon-envelope-alt"></i> pesodgteoffice@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
      ...
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          <h5 class="widgetheading">Recent Job Postings</h5>
          <ul class="link-list">
            <?php 
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>&copy; PESO Job Hunt App 2022 All right reserved.  
            </p>
          </div>
        </div>
        <div class="col-lg-6">
