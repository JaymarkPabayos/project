		...
		<div class="row"> 
							<div class="col-md-12">
								<div class="about-logo">
									<h3>PESO Job Hunt A Web-based Job Hunting System in Negros Oriental</h3>
									<p>We are located at PESO office Dumaguete city. </p>
                                    <p>For more information. Just visit us at our office from 8am-5pm </p>
								</div>  
							</div>
						</div>
	<div class="row">
								<div class="col-md-6">
									<p>Email us at: (peso email)</p>
									<p>Facebook: (peso fb)</p>
									<p>Twitter: (peso twitter)</p>
